    ...
    <section className="mb-20 md:mb-[120px] px-4 md:px-10 max-w-container mx-auto" aria-label="Call to action">
      ...
      >
        ...
        >
          <Link
            href="/contact"
            className="btn-shimmer text-on-secondary-container px-10 py-6 rounded-2xl font-headline font-semibold shadow-xl hover:brightness-110 transition-all duration-200 flex items-center justify-center gap-3 active:scale-95"
          >
            {t('ctaPrimary')}
          ...
          <Link
            ...
            className="bg-white/15 text-white border-2 border-white/25 px-10 py-6 rounded-2xl font-headline font-semibold hover:bg-white/25 transition-all duration-200 flex items-center justify-center gap-3 active:scale-95 backdrop-blur-sm"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
